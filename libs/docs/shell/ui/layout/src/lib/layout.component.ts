...
import { DocsLayoutEmptyComponent } from './layouts/empty/empty.component';
import { DocsLayoutMaterialComponent } from './layouts/material/material.component';
...
export class DocsLayoutComponent implements OnInit {
  ...
  private _updateLayoutDirection(): void {
    ...
    this._document.documentElement.setAttribute('lang', this.layoutConfig.lang);
