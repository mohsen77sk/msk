...
import { LayoutConfigService } from '@msk/shared/services/config';
...
export class MediaWatcherService {
   ...
   * Constructor
   */
  constructor(private _breakpointObserver: BreakpointObserver, private _layoutConfigService: LayoutConfigService) {
