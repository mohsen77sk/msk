...
export class MskNavigationService {
  ...
  private _navigationStore: Map<string, MskNavigationItem[]> = new Map<string, MskNavigationItem[]>();
   ...
   */
  getFlatNavigation(navigation: MskNavigationItem[], flatNavigation: MskNavigationItem[] = []): MskNavigationItem[] {
   ...
   * @param navigation
   */
  getItem(id: string, navigation: MskNavigationItem[]): MskNavigationItem | null {
    for (const item of navigation) {
      if (item.id === id) {
        return item;
      }
