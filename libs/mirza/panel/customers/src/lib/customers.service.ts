...
import { CustomersCardDetailsComponent } from './card/details/details.component';
...
export class CustomersService {
  ...
  getLookupCustomers(
    ...
    return this.getCustomers(params).pipe(
      map((response) => {
        return {
          ...response,
  ...
  openCustomerDialog(
    ...
    return this._translocoService
      ...
      .pipe(
        map(() =>
          this._matDialog.open(CustomersCardDetailsComponent, {
