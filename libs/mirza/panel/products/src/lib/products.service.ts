...
export class ProductsService {
   ...
   * @param data
   */
  openProductDialog(data: MskDialogData<Product | undefined>): MatDialogRef<ProductCardDetailsComponent> {
    return this._matDialog.open(ProductCardDetailsComponent, {
