...
export class ProductCategoriesCardDetailsComponent implements OnInit {
  ...
  deleteProductCategory(): void {
    ...
    confirmation.afterClosed().subscribe((result) => {
      ...
      this._productCategoriesServiceService
  ...
  saveAndClose(): void {
    ...
    const result =
      this.data.action() === 'edit'
        ? this._productCategoriesServiceService.updateProductCategory(this.form.value)
        : this._productCategoriesServiceService.createProductCategory(this.form.value);
