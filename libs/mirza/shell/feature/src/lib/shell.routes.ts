    ...
    children: [
      // Panel
      {
        ...
        children: [
          ...
          {
            path: 'expenses',
            loadChildren: () => import('@msk/mirza/panel/expenses').then((r) => r.routes),
          },
          {
            path: 'products',
          ...
          {
            path: 'purchases',
            loadChildren: () => import('@msk/mirza/panel/purchases').then((r) => r.routes),
          },
          {
            path: 'sales',
            loadChildren: () => import('@msk/mirza/panel/sales').then((r) => r.routes),
          },
        ],
      },
    ],
